...
--Tuesday
/*
INSERT INTO animals (name, species, date_of_birth, escape_attempts, neutered, weight_kg)
VALUES
('Charmander', NULL, DATE '2020-02-08', 0, 'FALSE', -11),
('Plantmon', NULL, DATE '2021-11-15', 2,'TRUE', -5.7),
('Squirtle', NULL, DATE '1993-04-02', 3, 'FALSE', -12.13),
('Angemon', NULL, DATE '2005-06-12', 1, 'TRUE', -45),
('Boarmon', NULL, DATE '2005-06-07', 7, 'TRUE', 20.4),
('Blossom', NULL, DATE '1998-10-13', 3, 'TRUE', 17),
('Ditto', NULL, DATE '2022-05-14', 4, 'TRUE', 22);
*/
